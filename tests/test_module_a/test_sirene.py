...
from fortress.module_a.sirene_downloader import (
    ResourceInfo,
    _file_is_recent,
    _verify_sha256,
    download_sirene,
...
from fortress.module_a.sirene_ingester import (
    normalize_naf_code,
    transform_row,
)
...
class TestDownloaderSkipRecent:
    ...
    async def test_download_skipped_when_recent(self, tmp_path: Path) -> None:
        ...
        with patch(
            "fortress.module_a.sirene_downloader.settings"
        ) as mock_settings, patch(
            "fortress.module_a.sirene_downloader.fetch_dataset_resources",
    ...
    async def test_download_forced_even_when_recent(self, tmp_path: Path) -> None:
        ...
        with patch(
            ...
            "fortress.module_a.sirene_downloader.download_file",
            new_callable=AsyncMock,
        ) as mock_dl:
            mock_settings.sirene_dir = tmp_path
