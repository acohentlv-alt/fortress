...
from fortress.module_c.curl_client import (
    USER_AGENTS,
    CurlClient,
    CurlClientError,
    CurlResponse,
...
class TestCurlClientGet:
    ...
    async def test_successful_get(self) -> None:
        ...
        with patch(
            "fortress.module_c.curl_client.AsyncSession",
            autospec=True,
        ) as MockSession:
            ...
            with patch("fortress.module_c.curl_client.asyncio.sleep", new_callable=AsyncMock):
                client = CurlClient()
