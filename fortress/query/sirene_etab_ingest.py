...
Usage:
    python -m fortress.query.sirene_etab_ingest [--refresh] [--limit N]
...
from fortress.query.sirene_download import download_etablissement
    ...
    *, refresh: bool = False, limit: int | None = None
    ...
    if etab_path is None or not etab_path.exists():
        raise FileNotFoundError(
            ...
            "Run: python -m fortress.query.sirene_download --etablissement"
        )
